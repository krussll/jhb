...
<figure class="wp-block-image size-full"><img src="{{ '/img/posts/taylor-vs-review.jpg' | prepend: site.baseurl | replace: '//', '/' }}" alt="Taylor Vector VS Review" class="wp-image-377"/></figure>
<!-- /wp:image -->
