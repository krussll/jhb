...
<figure class="wp-block-image size-full"><img src="{{ '/img/posts/how-much-does-lawn-bowls-cost.jpg' | prepend: site.baseurl | replace: '//', '/' }}" alt="How much lawn bowls costs" class="wp-image-282"/></figure>
<!-- /wp:image -->
