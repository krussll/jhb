...
<figure class="wp-block-image size-large"><img src="{{ '/img/posts/taylor-international-vs-aero-sonic-1024x576.jpg' | prepend: site.baseurl | replace: '//', '/' }}" alt="Taylor International vs Aero Sonic" class="wp-image-2008"/></figure>
<!-- /wp:image -->
