...
<figure class="wp-block-image size-large"><img src="{{ '/img/posts/henselite-tiger-tx-vs-aero-sonic-1024x576.jpg' | prepend: site.baseurl | replace: '//', '/' }}" alt="Henselite Tiger TX vs Aero Sonic" class="wp-image-1972"/></figure>
<!-- /wp:image -->
