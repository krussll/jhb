...
<figure class="wp-block-image size-full"><img src="{{ '/img/posts/Are-crown-green-bowls-the-same-as-flat-green-bowls.jpg' | prepend: site.baseurl | replace: '//', '/' }}" alt="" class="wp-image-1052"/></figure>
<!-- /wp:image -->
