...
<figure class="wp-block-image size-large"><img src="{{ '/img/posts/Aero-Sonic-1024x576.jpg' | prepend: site.baseurl | replace: '//', '/' }}" alt="" class="wp-image-3105"/></figure>
<!-- /wp:image -->
...
<!-- wp:list -->
<ul><!-- wp:list-item -->
<li>Great on outdoor surfaces<sup><a href="#aero-sonic-product">[1]</a></sup></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Versatile enough to handle different green speeds<sup><a href="#aero-sonic-product">[1]</a></sup></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Unique colour options<sup><a href="#aero-colours">[2]</a></sup> </li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Consistent lines every time<sup><a href="#aero-sonic-product">[1]</a></sup></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
...
<!-- wp:list -->
<ul><!-- wp:list-item -->
<li>Not many available on second hand marketplaces such as eBay<sup><a href="#aero-availability">[3]</a></sup></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:paragraph -->
<p>For those not familiar with the model, the Aero Sonic is a mid-to-wide biased bowl and is currently the widest bowl in the Aero range.<sup><a href="#aero-sonic-product">[1]</a></sup></p>
<!-- /wp:paragraph -->

<!-- wp:block {"ref":2833} /-->

<!-- wp:paragraph -->
<p>As with every bowl in the Aero range it has their Harbour Bridge trajectory. What you will find is an even turn from the mid-point onwards. This is smooth and predictable, which is great for leads and singles players.<sup><a href="#aero-sonic-product">[1]</a></sup></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>As with all Aero bowls, the Sonic is available in sizes 00-5 and in size "Heavy". This combination of options is something of an industry standard with new bowls.<sup><a href="#aero-sonic-product">[1]</a></sup></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>Aero does offer some half sizes too, which is great if you are struggling between sizes.<sup><a href="#aero-sonic-product">[1]</a></sup></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>This is where Aero set themselves apart, with the unique grip and colour options. These include - <sup><a href="#aero-colours">[2]</a></sup></p>
<!-- /wp:paragraph -->
...
<!-- wp:list -->
<ul><!-- wp:list-item -->
<li>The Zigzag<sup><a href="#aero-colours">[2]</a></sup></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>The Dententions<sup><a href="#aero-colours">[2]</a></sup></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>The Z-Scoop<sup><a href="#aero-colours">[2]</a></sup></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>plain rings<sup><a href="#aero-colours">[2]</a></sup></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
...
<!-- wp:list -->
<ul><!-- wp:list-item -->
<li>Solid colour<sup><a href="#aero-colours">[2]</a></sup></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Speckle colour<sup><a href="#aero-colours">[2]</a></sup></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Duo colour<sup><a href="#aero-colours">[2]</a></sup></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Trifecta colour<sup><a href="#aero-colours">[2]</a></sup></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Quad colour<sup><a href="#aero-colours">[2]</a></sup></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Picasso colour<sup><a href="#aero-colours">[2]</a></sup></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Rainbow colour<sup><a href="#aero-colours">[2]</a></sup></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
...
<!-- wp:paragraph -->
<p>Aero's Z-Scoop also has the advantage of the Zigzag pattern, which is unque to them. I haven't yet seen any other manufacturer attempt something similar.<sup><a href="#aero-colours">[2]</a></sup></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>For those who don't like this style of grip, do not fear as Aero also offer any of their other grip styles for free on all models.<sup><a href="#aero-colours">[2]</a></sup></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>Aero also leads the way with colour and grip options, which will make finding something that suits you a breeze.<sup><a href="#aero-colours">[2]</a></sup></p>
<!-- /wp:paragraph -->
...
<!-- wp:list -->
<ul><li id="aero-sonic-product"><a href="https://www.aerobowls.co.uk/collections/lawn-bowls/products/sonic" rel="noopener" target="_blank">Aero Bowls UK – Sonic Lawn Bowls</a></li><li id="aero-colours"><a href="https://www.aerobowls.co.uk/pages/bowls-colours-and-grips" rel="noopener" target="_blank">Aero Bowls UK – Bowl Colours &amp; Grips</a></li><li id="aero-availability"><a href="https://www.ebay.co.uk/sch/i.html?_nkw=Aero+Sonic+bowls" rel="noopener" target="_blank">eBay UK – “Aero Sonic bowls” Search Results</a></li></ul>
<!-- /wp:list -->
